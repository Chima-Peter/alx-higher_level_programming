...
class Rectangle:
    ...
    def bigger_or_equal(rect1, rect2):
        ...
        elif type(rect2) != Rectangle:
            "Checks if rect2 is an instance of rectangle"
            raise TypeError("rect2 must be an instance of Rectangle")
        '''
        else:
            "Checks for biggera nd equal"
            def __eq__(self, rect1, rect2):
                "Function yo check if equal"
                if rect1.area == rect2.area:
                    "Chcks if equal"
                    return rect1
            def __gt__(self, rect1, rect2):
                "Function to check whos lesser"
                if rect1.area > rect2.area:
                    "Checks whos lesser"
                    return True
            def __gt__(self, rect1, rect2):
                "Fnction to check whos bigger"
