#!/usr/bin/python3
"This module creates a class that measures the perimeter and area of a rectangle and aslo deletes an instance of rectangle"
class Rectangle: "The class to be measured in both it's area and rectangle"
